...
void App_CombinedSteering::Start()
{
	//blendedSteering
	m_pSeek = new Seek();
	m_pDrunkenWander = new Wander();
	m_pDrunkenWander->SetWanderOffset(0.f);
	vector<BlendedSteering::WeightedBehavior> weightedSteeringBehaviours;
	weightedSteeringBehaviours.push_back({ m_pSeek,0.5f });
	weightedSteeringBehaviours.push_back({ m_pDrunkenWander,0.5f });
	m_pBlendedSteering = new BlendedSteering(weightedSteeringBehaviours);
