...
{
	// delete our Agent with given Safe Delete
...
void App_Sandbox::Update(float deltaTime)
{
	...
	{
		auto mouseData = INPUTMANAGER->GetMouseData(InputType::eMouseButton, InputMouseButton::eLeft);
